...
$output.='<div class="pl-slider-slide item " >';
	$output .='<div class="pl-post-cnt pl-boxed-cnt pl-boxed-layout3">';
	   $output .='
				<div class="pl-thumbnail">';
					$output.='<div class="pl-boxed-detail-unvis '.$layout_three_effect.'">';
						$output.='<div class="'.$layout_three_align.'">';
					...
					$output.='</div>';
					$output .='
					 <div class="pl-thumbnail-img '.$layout_three_img_effect.' '.$image_hover.'">
